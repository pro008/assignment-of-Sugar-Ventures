...
# ------------------------------------------------------------
  ...
  # check if number profit or loss
  ...
  # handle merge loss and profit next to
  ...
  # return cluster profit and loss
  ...
  # format group as Profit | Loss| Profit
  ...
  # skim and group all nearest profit
